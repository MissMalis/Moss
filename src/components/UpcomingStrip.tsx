    ...
    <div className="grid grid-cols-7 gap-1.5">
      {days.map((day, i) => {
        ...
        return (
          <div
            key={day.date}
            className={`flex flex-col items-center gap-1.5 rounded-lg px-1 py-2 ${day.isToday ? "bg-moss-bg" : ""}`}
          >
            ...
            <div className="flex min-h-[24px] flex-col items-center gap-1">
              {day.items.map((item) => (
                <span
                  ...
                  className="flex h-5 w-5 items-center justify-center rounded-full text-[10px] font-medium text-bg"
            ...
            <div className="mt-auto w-full rounded-md bg-card-soft px-1 py-1 text-center text-[10.5px] tabular-nums text-ink-2">
